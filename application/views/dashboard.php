					...
					<div class="col-xl-3 col-xxl-3 col-sm-6">
						<div class="card bg-warning invoice-card">
							<div class="card-body d-flex">
								...
								<div>
									<h2 class="text-white invoice-num"><?php echo $total_peserta ?></h2>
						...
						<div class="card bg-success invoice-card">
							<div class="card-body d-flex">
								...
								<div>
									...
									<span class="text-white fs-18">Anggota Aktif</span>
								</div>
							</div>
						</div>
					</div>
						...
						<div class="card bg-info invoice-card">
							<div class="card-body d-flex">
								...
								<div>
									...
									<span class="text-white fs-18">Anggota Tidak Aktif</span>
								</div>
							</div>
						</div>
					</div>
				...
				<div class="row">
								...
								<div class="row align-items-center">
									<div class="col-xl-6">
										<div class="card-bx bg-blue">
											<img class="pattern-img" src="assets/template/images/pattern/pattern6.png" alt="">
											<div class="card-info text-white">
												<img src="assets/template/images/pattern/circle.png" class="mb-4" alt="">
					...
					<div class="col-xl-3 col-xxl-7">
						<div class="card">
							...
							<div class="card-body">
								<div class="user-bx">
									<img src="assets/template/images/profile/small/pic1.jpg" alt="">
									<div>
								...
								<ul class="user-list">
									<li><img src="assets/template/images/avatar/1.jpg" alt=""></li>
									<li><img src="assets/template/images/avatar/2.jpg" alt=""></li>
									<li><img src="assets/template/images/avatar/3.jpg" alt=""></li>
									<li><img src="assets/template/images/avatar/4.jpg" alt=""></li>
									<li><img src="assets/template/images/avatar/5.jpg" alt=""></li>
									<li><img src="assets/template/images/avatar/6.jpg" alt=""></li>
								</ul>
