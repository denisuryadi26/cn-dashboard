        ...
        <ul class="metismenu" id="menu">
            <li class="dropdown header-profile">
                <a class="nav-link" href="javascript:void(0);" role="button" data-bs-toggle="dropdown">
                    <img src="assets/template/images/profile/pic1.jpg" width="20" alt="">
                    <div class="header-info ms-3">
                        <span class="font-w600 ">Hi, <b><?php echo $this->session->userdata('display_name') ?></b></span>
                        <small class="text-end font-w400"><?php echo $this->session->userdata('email') ?></small>
                    </div>
                </a>
            ...
            <li><a class="has-arrow ai-icon" href="javascript:void()" aria-expanded="false">
                ...
                <ul aria-expanded="false">
                    <li><a href="<?php echo base_url('peserta') ?>">Data Anggota</a></li>
                    <li><a href="<?php echo base_url('kta') ?>">KTA</a></li>
                    <?php if ($this->session->userdata('privilege_id') == '1') : { ?>
